import {
  ...
  const PROXY_CONTRACT_ADDRESS_BY_VERSION_BY_NETWORK: IProxyContractByVersionByNetwork = {
    ['0.1.0']: {
      //not deployed on mainet
    //   mainnet: {
    //     address: '0x5f821c20947ff9be22e823edc5b3c709b33121b3',
    //     creationBlockNumber: 9119380,
    //   },
      private: {
        address: '0x2b76b88bC687FF9B0D85a2749Bc0B62502c8e746',
        creationBlockNumber: 0,
      },
      rinkeby: {
        address: '0x1f7c8dc4d0803f3493005d43fc3768167c3c7b60',
  ...
  /**
   * Handle payment networks with StarNotary proxy contract extension
   */
  export default class PaymentNetworkStarNotaryProxyContract implements PaymentTypes.IPaymentNetwork {
    private extension: ExtensionTypes.PnReferenceBased.IReferenceBased;
    /**
     * @param extension The advanced logic payment network extensions
     */
    public constructor({ advancedLogic }: { advancedLogic: AdvancedLogicTypes.IAdvancedLogic }) {
      this.extension = advancedLogic.extensions.proxyContractStarNotary;
    }
    ...
    public async getBalance(
      ...
      const paymentNetworkId = ExtensionTypes.ID.PAYMENT_NETWORK_STARNOTARY_PROXY_CONTRACT;
      ...
      try {
        ...
        const events: PaymentTypes.StarNotaryPaymentNetworkEvent[] = [
          ...payments.events,
          ...refunds.events,
    ...
    private async extractBalanceAndEvents(
      ...
      if (!network) {
        throw new NetworkNotSupported(`Payment network not supported by StarNotary payment detection`);
      }
